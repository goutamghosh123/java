    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)Pathancoat  | RS-600 |   "+available[1]+"   **");
    					System.out.println("** 2.) Jalandhar  | RS-170 |   "+available[2]+"   **");
    					System.out.println("** 3.)Ambala      | RS-150 |   "+available[3]+"   **");
    					System.out.println("** 4.)Amritsar    | RS-200 |   "+available[4]+"   **");
    					System.out.println("** 5.)Phagwara     | RS-250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "Pathancoat", "Jalandhar", "Ambala", "Amritsar", "Phagwara "};
